        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h3>Herramientas</h3>
                    <hr>
                    <div class="col-sm-12" id="div_table_tools">
...
<?php
    ...
    wp_enqueue_script( 'manage_tools.js', get_template_directory_uri().'/js/tools_dintev/manage_tools.js');
