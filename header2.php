...
<link rel="icon" href="<?php echo get_template_directory_uri().'/images/icono_rpvitie.png' ?>">
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div class="nav-wrap">
			<div class=menu-dintev>
				...
				?>
				<a href="http://dintev.univalle.edu.co/sistema-vigilancia-tecnologica.html" target="blank" class="text-menu-dintev">Sistema de Vigilancia Tecnológica (SVTIE)</a>
			</div>
		</div>
	</header><!-- #masthead --> 
